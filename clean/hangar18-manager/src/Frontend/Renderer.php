...
final class Renderer
{
    ...
    public static function css(): void
    {
        ...
        echo '.h18-clean-front-event-list{display:grid;width:100%;box-sizing:border-box}.h18-clean-front-event-card{display:flex;flex-direction:column;gap:8px;min-width:0;box-sizing:border-box;text-decoration:none;color:inherit;overflow:hidden}.h18-clean-front-event-card img{display:block;width:100%;max-width:none;object-fit:cover}.h18-clean-front-event-card h3,.h18-clean-front-event-card p{margin:0}.h18-clean-front-event-meta{display:flex;flex-wrap:wrap;gap:6px 14px}.h18-clean-front-event-detail{box-sizing:border-box}.h18-clean-front-event-hero{display:block;width:100%;max-width:none;object-fit:cover;margin-bottom:14px}.h18-clean-front-event-description{margin-top:16px}@media(max-width:782px){.h18-clean-front-event-list{grid-template-columns:1fr!important}}';
