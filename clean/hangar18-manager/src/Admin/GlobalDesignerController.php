...
final class GlobalDesignerController
{
    ...
    public static function render(): void
    {
        ...
        echo '<label>Indre max-bredde px <input type="number" name="global_content_width" min="320" max="2400" value="' . esc_attr((string) ($settings['contentWidth'] ?? 1440)) . '"></label><p class="description">Theme-shell er aktiv på Visual Designer-sider. Header/Footer resolveren bruger sidevalg → aktiv website-standard → sikker tom fallback og deles med Preview.</p></section>';
        ...
        foreach (['section' => 'Sektion', 'container' => 'Kasse', 'text' => 'Tekst', 'image' => 'Billede', 'button' => 'Knap', 'link' => 'Link', 'menu' => 'Menu', 'spacer' => 'Mellemrum', 'divider' => 'Skillelinje', 'icon' => 'Ikon', 'badge' => 'Badge', 'datalist' => 'Data List', 'table' => 'Tabel'] as $type => $elementLabel) { echo '<button type="button" draggable="true" class="button h18-clean-add" data-type="' . esc_attr($type) . '">+ ' . esc_html($elementLabel) . '</button>'; }
