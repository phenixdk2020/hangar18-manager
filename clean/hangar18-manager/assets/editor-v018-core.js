(function () {
    ...
    const TYPES = ['section', 'container', 'text', 'image', 'button', 'menu', 'spacer', 'divider', 'icon', 'badge', 'link', 'datalist', 'table', 'vehiclelist', 'vehicledetail', 'eventlist', 'eventdetail', 'gallerylist', 'gallerydetail', 'eventfield', 'contactform', 'membershipform'];
    ...
    function addNode(type, parentId, source, dropGeometry) {
        ...
        const defaultRows = { section: 20, container: 16, text: 14, image: 20, button: 8, menu: 10, spacer: 4, divider: 6, icon: 10, badge: 8, link: 8, datalist: 18, table: 22, vehiclelist: 42, vehicledetail: 54, eventlist: 38, eventdetail: 46, gallerylist: 40, gallerydetail: 52, eventfield: 18, contactform: 54, membershipform: 74 };
