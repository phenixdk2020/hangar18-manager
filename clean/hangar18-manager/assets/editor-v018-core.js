(function () {
    ...
    const TYPES = ['section', 'container', 'text', 'image', 'button', 'menu', 'spacer', 'divider', 'icon', 'badge', 'link', 'datalist', 'table', 'vehiclelist', 'vehicledetail', 'eventlist', 'eventdetail', 'eventvalue', 'eventimage', 'gallerylist', 'gallerydetail', 'eventfield', 'contactform', 'membershipform'];
    ...
    function renderSurface(parentId, surface) {
        ...
        list.forEach(function (node) {
            ...
            title.textContent = ({section:'SEKTION',container:'KASSE',text:'TEKST',image:'BILLEDE',button:'KNAP',menu:'MENU',spacer:'MELLEMRUM',divider:'SKILLELINJE',icon:'IKON',badge:'BADGE',link:'LINK',datalist:'DATA LIST',table:'TABEL',vehiclelist:'KØRETØJSLISTE',vehicledetail:'KØRETØJSDETALJE',eventlist:'EVENTLISTE',eventdetail:'EVENTDETALJE',eventvalue:'EVENTVÆRDI',eventimage:'EVENTBILLEDE',eventfield:'EVENTFELT',gallerylist:'GALLERIOVERSIGT',gallerydetail:'ALBUMVISNING',contactform:'KONTAKTFORMULAR',membershipform:'BLIV MEDLEM-FORMULAR'}[node.type] || node.type.toUpperCase()) + ' · ' + node.id.slice(-8);
    ...
    function renderInspector() {
        ...
        const g = node.geometry.desktop;
        let html = '<div class="h18-clean-inspector-head"><strong>' + escapeHtml(({section:'SEKTION',container:'KASSE',text:'TEKST',image:'BILLEDE',button:'KNAP',menu:'MENU',spacer:'MELLEMRUM',divider:'SKILLELINJE',icon:'IKON',badge:'BADGE',link:'LINK',datalist:'DATA LIST',table:'TABEL',vehiclelist:'KØRETØJSLISTE',vehicledetail:'KØRETØJSDETALJE',eventlist:'EVENTLISTE',eventdetail:'EVENTDETALJE',eventvalue:'EVENTVÆRDI',eventimage:'EVENTBILLEDE',eventfield:'EVENTFELT',gallerylist:'GALLERIOVERSIGT',gallerydetail:'ALBUMVISNING',contactform:'KONTAKTFORMULAR',membershipform:'BLIV MEDLEM-FORMULAR'}[node.type] || node.type.toUpperCase())) + '</strong><code>' + escapeHtml(node.id) + '</code></div>';
