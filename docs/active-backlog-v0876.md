...
4. Vælg Restore.
5. Opret automatisk safety-version af aktuel side.
6. Restore kun den valgte side/version.
7. Verificer canonical store + WordPress page output.
8. Undo skal kunne gå tilbage til safety-versionen.
