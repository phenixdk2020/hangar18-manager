...
- Base branch: `main` after Architecture Foundation
...
The phase also adds strict comparison infrastructure:

- state comparison uses strict recursive equality;
- markup comparison normalizes line endings only;
- required Vehicle/Event/Gallery hooks are catalogued in code;
- protected-domain markup can be audited old-vs-new;
- page state can be audited legacy-vs-repository in read-only shadow mode.
...
- compatibility comparator and shadow-audit tests.
