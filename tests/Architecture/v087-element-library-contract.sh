...
# EVENT-001 is such an explicit slice. v0.8.32-v0.8.34 also contain narrowly
...
protected_changes="$(
  git diff --name-only origin/main...HEAD |
    ...
    grep -Ev '^src/Event/EventArchiveRuntime\.php$|^tests/Architecture/event-auto-archive-(smoke\.php|contract\.sh)$|^\.github/workflows/event-auto-archive-qa\.yml$|^assets/ultimate-designer-lego-design-event-guard-v0832\.js$|^assets/ultimate-designer-lego-design-responsive-event-guard-v0833\.js$|^assets/ultimate-designer-lego-interaction-states-event-guard-v0834\.js$' || true
)"
