...
require_contains "$JS" "device + '.Margin.X'" 'per-element X axis control is missing'
require_contains "$JS" "device + '.Margin.Y'" 'per-element Y axis control is missing'
require_contains "$JS" "device + '.Gap.X'" 'Kasse/layout X gap control is missing'
require_contains "$JS" "device + '.Gap.Y'" 'Kasse/layout Y gap control is missing'
require_contains "$JS" "deviceGroup('Desktop', 'Desktop'" 'desktop spacing controls are missing'
require_contains "$JS" "deviceGroup('Mobil', 'Mobile'" 'mobile spacing controls are missing'
