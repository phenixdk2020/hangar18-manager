(function () {
    ...
    if (window.__h18HistoryCoreBridgeV0820) { return; }
    ...
    document.documentElement.setAttribute('data-h18-v0820-history-runtime', '1');
    ...
    function installGuardBridge() {
        ...
        if (guard.__h18V0820HistoryBridge) { return guard; }
        ...
        guard.__h18V0820HistoryBridge = true;
        return guard;
    }
    ...
    function installRuntimeIdentity() {
        ...
        if (!status) { return; }
        status.setAttribute('data-h18-history-runtime', '0.8.20');
        status.setAttribute('title', 'History runtime 0.8.20');
        if (!document.getElementById('h18-history-runtime-badge')) {
            const badge = document.createElement('small');
            badge.id = 'h18-history-runtime-badge';
            badge.textContent = 'H0.8.20';
            badge.title = 'Aktiv historikmotor 0.8.20';
    ...
    window.__h18HistoryCoreBridgeV0820 = {
