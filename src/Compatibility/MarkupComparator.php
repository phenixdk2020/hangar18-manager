...
/**
 * Compares legacy and candidate markup before a renderer can be switched.
 * Line endings are normalized, while all other markup is compared strictly.
 */
final class MarkupComparator
{
    /** @param list<string> $requiredHooks */
