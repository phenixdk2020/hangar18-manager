...
/**
 * Machine-readable v0.5.30 compatibility contract for the three protected
 * Hangar18 domains. Future replacements must satisfy these hooks/actions before
 * the compatibility policy can be relaxed.
 */
