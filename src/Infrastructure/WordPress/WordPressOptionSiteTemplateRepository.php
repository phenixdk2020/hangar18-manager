...
/**
 * WordPress option-backed Site Builder template persistence.
 *
 * This is intentionally separate from hangar18_manager_pages_v1 and from the
 * legacy header design option so template work cannot mutate current pages.
 */
