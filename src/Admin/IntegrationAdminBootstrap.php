...
final class IntegrationAdminBootstrap
{
    ...
    public static function register(): void
    {
        ...
        SiteBackupAdminController::register();
    ...
    public static function render(): void
    {
        ...
        self::card('LEGO spacing','X/Y · element + Kasse','Fælles admin-only spacing-model oven på eksisterende element/parent/history-motor. Legacy LayoutGap er kompatibilitetsfallback.');
        ...
        LegacyShellShadowAdminController::renderPanel();SiteTemplateAdminController::renderPanel();MenuAdminController::renderPanel();BackupRestoreAdminController::renderPanel();SiteBackupAdminController::renderPanel();AssetManagerAdminController::renderPanel();PortabilityAdminController::renderPanel();PermissionsAdminController::renderPanel();AiAdminController::renderPanel();QaDashboardAdminController::renderPanel();ConversionAdminController::renderPanel();CutoverPreflightAdminController::renderPanel();DecisionPacketAdminController::renderPanel();
