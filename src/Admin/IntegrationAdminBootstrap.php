...
final class IntegrationAdminBootstrap
{
    ...
    public static function render(): void
    {
        ...
        SiteTemplateAdminController::renderPanel();MenuAdminController::renderPanel();AssetManagerAdminController::renderPanel();PortabilityAdminController::renderPanel();PermissionsAdminController::renderPanel();AiAdminController::renderPanel();
