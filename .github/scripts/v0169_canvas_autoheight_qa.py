...
require('Version: 0.1.69' in plugin and "H18_CLEAN_VERSION', '0.1.69'" in plugin, 'plugin/runtime version is 0.1.69')
...
require('0.1.69 – Canvas Auto Height' in notes, 'release notes are current')
...
print('V0169 CANVAS AUTO HEIGHT QA OK')
